...
const ExaminationModal: React.FC<ExaminationModalProps> = ({ text, onClose }) => {
  return (
    <div 
    ...
    >
      ...
      >
        ...
        <h2 id="examination-modal-title" className="font-press-start text-xl sm:text-2xl mb-4 text-teal-300">Upon Closer Inspection...</h2>
        <div className="max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
          <p className="text-gray-300 whitespace-pre-line leading-relaxed text-base sm:text-lg"> {/* Increased font size */}
            {text}
          </p>
        </div>
        <button
