...
const genreDescriptions: Record<GameGenre, string> = {
  "Dark Fantasy": "A grim world of perilous magic, ancient evils, and morally ambiguous choices.",
  "Sci-Fi Detective": "Unravel complex mysteries in a futuristic city, using advanced tech and keen observation.",
  "Post-Apocalyptic Survival": "Navigate a harsh, ruined world, scavenging for resources and facing constant danger.",
  "Mythological Epic": "Embark on a grand quest inspired by ancient myths, encountering gods, monsters, and legendary heroes.",
  "Steampunk Chronicle": "Explore a world of Victorian aesthetics, steam-powered marvels, and daring inventions.",
  "Cosmic Horror": "Confront sanity-shattering truths and entities from beyond the stars in a universe indifferent to humanity."
};
