    ...
    >
      <div className="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl text-center max-w-md w-full border border-gray-700">
        <h2
          ...
          className="font-press-start text-xl sm:text-2xl mb-6 text-purple-300"
        >
          Adventure Awaits!
        </h2>
        <p className="text-gray-300 mb-8 text-base sm:text-lg">
          {' '}
          {/* Increased font size */}
          An echo of your past journey lingers. Would you like to continue where
          you left off, or shall we scribe a new legend?
        </p>
