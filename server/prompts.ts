...
// Copied from types.ts (as it was in previous successful setup)
export const genrePersonaDetails: GenreSpecificPersonaDetails = {
  'Dark Fantasy': {
    'Cautious Scholar': { title: 'Lorekeeper of Shadows', description: 'Scours forbidden texts...' },
    'Brave Warrior': { title: 'Grim Warden', description: 'A stoic defender...' },
    'Cunning Rogue': { title: 'Grave Robber', description: 'Navigates treacherous crypts...' },
    'Mysterious Wanderer': { title: 'Curse-Touched Nomad', description: 'A solitary figure...' }
  },
  'Sci-Fi Detective': {
    'Cautious Scholar': { title: 'Data Forensics Analyst', description: 'Meticulously sifts...' },
    'Brave Warrior': { title: 'Cybernetic Enforcer', description: 'A city police officer...' },
    'Cunning Rogue': { title: 'Information Broker', description: "A master of infiltration..." },
    'Mysterious Wanderer': { title: 'Off-World Investigator', description: "An enigmatic detective..." }
  },
  'Post-Apocalyptic Survival': {
    'Cautious Scholar': { title: 'Wasteland Historian', description: "Preserves fragments..." },
    'Brave Warrior': { title: 'Settlement Guardian', description: 'Protects their small community...' },
    'Cunning Rogue': { title: 'Ruin Scavenger', description: 'Expertly navigates...' },
    'Mysterious Wanderer': { title: 'Lone Survivor', description: 'A hardened individual...' }
  },
  'Mythological Epic': {
    'Cautious Scholar': { title: "Oracle's Acolyte", description: 'Studies ancient prophecies...' },
    'Brave Warrior': { title: 'Demigod Hero', description: 'Possessing divine blood...' },
    'Cunning Rogue': { title: "Trickster's Chosen", description: 'Favored by a deity...' },
    'Mysterious Wanderer': { title: 'Exiled Deity', description: 'A lesser god or spirit...' }
  },
  'Steampunk Chronicle': {
    'Cautious Scholar': { title: 'Clockwork Theorist', description: 'Delves into the intricacies...' },
    'Brave Warrior': { title: 'Sky Captain', description: 'Commands a magnificent airship...' },
    'Cunning Rogue': { title: 'Gear-Driven Infiltrator', description: 'Utilizes ingenious gadgets...' },
    'Mysterious Wanderer': { title: 'Time-Displaced Inventor', description: 'An anachronistic genius...' }
  },
  'Cosmic Horror': {
    'Cautious Scholar': { title: 'Forbidden Scholar', description: 'Obsessively researches...' },
    'Brave Warrior': { title: 'Doomed Investigator', description: 'Attempts to confront...' },
    'Cunning Rogue': { title: 'Cult Infiltrator', description: 'Navigates the shadowy fringes...' },
    'Mysterious Wanderer': { title: 'Touched by the Void', description: 'An individual who has glimpsed...' }
  }
  // Descriptions are truncated for brevity in this recreation from memory; the actual file had full descriptions.
  // The tool will use the full descriptions if it has access to the original file content.
};
...
- For the 'sceneDescription' field:
    - ${ isInitialScene ? 'For this initial scene, or if the player is entering a new major location/area, ensure the sceneDescription is immersive and establishes the setting and atmosphere effectively (approx. 3-5 sentences).'
...
export const generateActionFeasibilityPrompt = (
  ...
  const genreSpecificPersonaTitle =
    genrePersonaDetails[selectedGenre]?.[selectedPersona]?.title || selectedPersona;
